...
from datamodel.search.NhtonZwalls_datamodel import NhtonZwallsProjectionLink
...
@Deleter(NhtonZwallsProjectionLink)
@Getter(NhtonZwallsProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(NhtonZwallsProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(NhtonZwallsProjectionLink, l)
